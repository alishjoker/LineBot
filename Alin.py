...
helpMessage ="""✟aʟɨsɦ ʝօҡɛʀ✟一�:緑 BOTS

Creator : Http://line.me/ti/p/~Joker.alish
"""
helo=""
...
#----------------------ADMIN COMMAND------------------------------#
            ...
            if msg.text.lower() in ["mention"]:
              ...
              if msg.from_ in admin:
                ...
                msg.contentType = 13
                adm = 'uf8a48d9747927d8e1c14cf1cae0f6539'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"INFO CREATOR\n\nILine:Id Joker.alish\ntelegram: alish_joker\nsite: www.freetimeine.mihanblog.com\nNama: Alish Joker\nTTL: Supporr, freetimeine@gmail.com\nChannel: @alihack011\ncuntry: Iran\nteam: caspian")
...
#            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by alish Joker \n\nhttp://line.me/joker.alish")
#            ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],free Line Theme \n\nwww.freetimeine.mihanblog.com")
#            ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"add Me \n\nHttp://line.me/ti/p/~Joker.alish")
#            ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"channel \n\nt.me/alihack011")
#            ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"🇦 🇱 🇮 🇸 🇭  🇯 🇴 🇰 🇪 🇷 \n\nhttp://line.me/ti/p/~alish.like1")
#            ki6.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Alish Joker Like Bot\n\nHttp://line.me/ti/p/~alish.like1")
#            print "Like"
#            print "Like"
#            print "Like"
#          except:
